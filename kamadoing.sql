...
INSERT INTO `receptboeken` (`BoekID`, `Titel`, `PublicatieDatum`, `Auteurnaam`, `Prijs`) VALUES
(1, 'BeterBBQ - Roken doe je op hout', '24/07/2022', 'Jeroen Hazebroek', '€9,99'),
(2, 'BeterBBQ - Handig met de houtskool BBQ', '18/08/2021', 'Leonard Elenbaas', '€9,99'),
(3, 'BeterBBQ - Keilekker op de kleine kamado', '15/07/2021', 'Jeroen Hazebroek', '€15,99')
