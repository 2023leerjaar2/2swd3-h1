...
<head>
  <meta charset="UTF-8">
  <title>Kamadoing - Gebruiker Verwijderen</title>
</head>
<body>

<h1>Gebruiker Verwijderen</h1>

<form method="post" action="verwijder_gebruiker.php">
  <label for="gebruikersnaam">Gebruikersnaam:</label>
  <input type="text" id="gebruikersnaam" name="gebruikersnaam" placeholder="Vul hier gebruikersnaam in!" required>
  <br><br>
  <input type="submit" value="Verwijder Gebruiker" class="delete-button">
</form>
